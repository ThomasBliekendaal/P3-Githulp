...
public class MH_StaminaPotion : MH_Potion {
    ...
    public override void Interact(GameObject target)
    {
        ...
        GameObject.FindGameObjectWithTag("UIManager").GetComponent<MH_UIManager>().UpdateEnergy(target.GetComponent<MH_Player>().energy, target.GetComponent<MH_Player>().maxEnergy);
